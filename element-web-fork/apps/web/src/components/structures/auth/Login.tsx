...
export default class LoginComponent extends React.PureComponent<IProps, IState> {
    ...
    // Phantomz: SSO disabled — username/password only
    private renderSsoStep = (_loginType: "cas" | "sso"): JSX.Element => {
        return <></>;
    };
    ...
    public render(): React.ReactNode {
        ...
        // Phantomz: Registration disabled — admin creates accounts only
